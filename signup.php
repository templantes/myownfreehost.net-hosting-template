...
<p><img class="btn btn-default" src="http://order.<? echo "$yourdomain" ;?>/image.php?id=<?PHP echo $id; ?>"></p>
<p><input class="form-control" placeholder="Security Code" type=text pattern=".{4,6}" name=number required></p>
